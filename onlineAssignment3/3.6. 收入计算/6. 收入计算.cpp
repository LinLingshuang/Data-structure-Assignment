...
//Tiger 拿出了公司的账本，账本上记录了公司成立以来每天的营业额。分析营业情况是一项相当复杂的工作。
//由于节假日，大减价或者是其他情况的时候，营业额会出现一定的波动，当然一定的波动是能够接受的，
//但是在某些时候营业额突变得很高或是很低，这就证明公司此时的经营状况出现了问题。
//经济管理学上定义了一种最小波动值来衡量这种情况：当最小波动值越大时，就说明营业情况越不稳定。
//而分析整个公司的从成立到现在营业情况是否稳定，只需要把每一天的最小波动值加起来就可以了。
//你的任务就是编写一个程序帮助 Tiger 来计算这一个值。
//我们定义，一天的最小波动值 = min{ ∣该天以前某一天的营业额−该天营业额∣ }。
//特别地，第一天的最小波动值为第一天的营业额。
//【输入形式】
//第一行为正整数 n（n≤32767） ，表示该公司从成立一直到现在的天数，接下来的 n 行每行有一个整数 ai（∣ai∣≤10^6) ，
